<template>
  <template v-if="departmentData">
    ...
    <BaseImgSection v-if="departmentData.supervisory_team[0]"
      ...
      :description="departmentData.supervisory_team[0].description" :imgPath="departmentData.supervisory_team[0].image"
      :animate="true" />
    <DepartmentVideo :video="departmentVideo" :description="departmentData.description_video" v-if="departmentVideo" />
